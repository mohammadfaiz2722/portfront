...
const projects = [
  ...
  {
    name: 'Portfolio',
    description: 'Explore the cosmos of my journey with a space-themed portfolio',
    technologies: ['HTML', 'CSS', 'JavaScript'],
  ...
  {
    name: 'Cosmic Vault',
    description: 'Cosmic Vault: Your gateway to a universe of memories',
    technologies: ['React', 'Node.js', 'MongoDB'],
...
export default OldProjectsShowcase;