...
const OldSkillsSection = () => {
  ...
  return (
    <section className="bg-black py-20 relative overflow-hidden" id="skills">
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        >
          <span style={{ fontFamily: '"Style Script", cursive', fontSize: 60 }}>My Skills</span>
        </motion.h2>
...
export default OldSkillsSection;